...
{
    public class DashboardMultiFilterMp
    {
        ...
        public DataTable GetMpCompanyFromDb(string userId, string empType, string companyCode, string divisionCode, string unitCode, string departmentCode, string sectionCode, string subSectionCode, string line, string currentDate, string activityCode)
        {
        ...
        {
            _cmd = new SqlCommand("[dbo].[Dashboard_Get_MP_UserDefine_CompanyWise_Multi_Filter_By_Line]", conn);
